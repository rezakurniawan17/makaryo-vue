<template>
  <section class="relative text-gray-600 body-font" id="contact-app">
  <div class="container px-5 py-24 mx-auto">
    ...
    <div class="mx-auto lg:w-1/2 md:w-2/3">
      <div class="flex flex-wrap -m-2">
        ...
        <div class="w-full p-2">
          <button class="flex px-8 py-2 mx-auto text-lg text-white border-0 rounded bg-emerald-500 focus:outline-none hover:bg-indigo-600">Button</button>
        </div>
        <div class="w-full p-2 pt-8 mt-8 text-center border-t border-gray-200">
          <a class="text-emerald-500">makaryoindonesia99@email.com</a>
          <p class="my-5 leading-normal">Jawa Tengah
            <br>Indonesia
          </p>
          <span class="inline-flex">
            <a class="text-gray-500 hover:text-emerald-500">
              <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
                <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
              </svg>
            </a>
            <a class="ml-4 text-gray-500 hover:text-emerald-500">
              <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
