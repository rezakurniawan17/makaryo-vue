<template>
<div class="container p-4 px-5 py-24 mx-auto bg-white dark:bg-gray-800" id="feature-app">
  <div class="lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:gap-12 lg:items-center">
    <div class="lg:col-start-2 md:pl-20">
      ...
      <ul class="mt-6">
        <li class="mb-4" v-for="aboutList in aboutLists" :key="aboutList.id">
            <div class="flex p-2 transition-all duration-500 ease-in-out transform bg-white border-2 border-transparent rounded-md group hover:border-indigo-500 hover:-translate-y-4">
                <div class="flex-shrink-0">
                    <div class="flex items-center justify-center w-12 h-12 rounded-md">
                        <img :src="aboutList.img" alt="">
                    </div>
                </div>
                <div class="ml-4">
                    <h5 class="text-lg font-bold leading-6 text-gray-900 duration-500 group-hover:text-indigo-600 dark:text-white">
                        {{ aboutList.title }}
                    </h5>
    ...
    <div class="hidden mt-10 -mx-4 lg:block md:-mx-12 lg:mt-0 lg:col-start-1">
        <img src="../assets/icons/startup.png" alt="illustration" class="relative w-auto mx-auto rounded"/>
    </div>
  </div>
</div>
</template>
